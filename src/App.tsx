      ...
      >
                      ...
                      {row.split("").map((cell) =>
                        cell !== "0" ? (
                          <div
                            ...
                            style={{
                              backgroundColor: theme.accents[holdShape],
              ...
              >
                ...
                <circle
                  ...
                  strokeDashoffset={
                    (596.68 *
                      (10 -
                        (linesCleared + 10 * Math.floor(linesCleared / 10)))) /
                    10
                  }
                  fill="transparent"
                  strokeDasharray="596.68px"
        ...
        <div className="w-[45vmin] h-[90vmin] flex items-center justify-center">
          ...
          >
            ...
            {ghost.map((pos: any, ind: any) => (
              <rect
                ...
                style={{
                  transitionDuration: autoplay ? dur / 4 + "ms" : "25ms",
                }}
                width={100}
                height={100}
                rx={10}
          ...
          <div className="w-[48vmin] mt-[-5vmin] absolute h-[20vmin]">
            ...
            />
            <SettingsScreen props={{ show: controls || true, theme }} />
          </div>
        </div>
        <div
        ...
        >
                      ...
                      {row.split("").map((cell) =>
                        cell !== "0" ? (
                          <div
                            className="w-[4vmin] aspect-square rounded-[0.4vmin] border"
                            style={{
                              backgroundColor: theme.accents[nextShape],
                              borderColor: theme.background,
                            }}
                          ></div>
                        ) : (
          ...
          <div className="h-full w-full flex flex-col items-center justify-center ">
            <div
              ...
              style={{
                marginTop: !autp || !started ? "0" : "-17.25vmin",
              }}
            >
              Autoplay
            </div>
            ...
            >
              <div
                ...
                style={{
                  ...
                  backgroundColor:
                    autp && started ? theme.accents[4] : theme.accents[5],
                }}
              ></div>
            </div>
            <div
              ...
              <div className="w-full flex justify-between px-[0.25vmin] gap-[1.5vmin]">
                ...
                <div className="w-[8.5vmin]  gap-[0.5vmin] justify-between flex ">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      weights.deepestHole = parseFloat(e.target.value);
                    }}
                  />
                </div>
              </div>
