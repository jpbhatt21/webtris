...
function App() {
  ...
  const [ghost, setGhost] = useState(JSON.parse(JSON.stringify(activePos[0])));
  let shapesy = [
    "1111",
    "100 111",
    "001 111",
                    ...
                    switch (rot) {
                      case 0:
                        [act, rot] = rotPiece(
                          ...
                          shape,
                          rot,
                          act.map((pos: any) => [pos[0] - 1, pos[1] - 2])
                        );
                        break;
                      case 1:
                        [act, rot] = rotPiece(
                          ...
                          shape,
                          rot,
                          act.map((pos: any) => [pos[0] + 2, pos[1] - 1])
                        );
                        break;
                      case 2:
                        [act, rot] = rotPiece(
                    ...
                    switch (rot) {
                      case 0:
                        [act, rot] = rotPiece(
                          ...
                          shape,
                          rot,
                          act.map((pos: any) => [pos[0] + 1, pos[1] - 1])
                        );
                        break;
                      case 1:
                        [act, rot] = rotPiece(
        ...
        <div className="h-full w-[18vmin] flex flex-col justify-center items-center  text-white">
          <div className="h-full w-full flex flex-col items-center justify-center text-white">
            <div
              ...
              className="h-[4vmin] cursor-pointer select-none -mt-[8vmin] mb-[4vmin] flex items-center justify-center"
            >
              {svg.cont}
              <label className="mt-[1.25vmin]">Controls</label>{" "}
            </div>
                      ...
                      {row.split("").map((cell) =>
                        cell !== "0" ? (
                          <div
                            ...
                            style={{
                              backgroundColor: cols[holdShape],
                            }}
                          ></div>
                        ) : (
                ...
                <circle
                  ...
                  stroke={
                    !(linesCleared % 20 < 10)
                      ? "#" +
                        (
                          Math.floor((((linesCleared % 20) - 10) / 10) * 72) +
                          163
                        ).toString(16) +
                        (
                          Math.floor((((linesCleared % 20) - 10) / 10) * 13) +
                          190
                        ).toString(16) +
                        (140).toString(16)
                      : "#" +
                        (
                          235 - Math.floor(((linesCleared % 20) / 10) * 72)
                        ).toString(16) +
                        (
                          203 - Math.floor(((linesCleared % 20) / 10) * 13)
                        ).toString(16) +
                        (140).toString(16)
                  }
                  strokeWidth={10}
                  strokeLinecap="round"
                  strokeDashoffset={(596.68 * (10 - linesCleared)) / 10}
                  fill="transparent"
                  strokeDasharray="596.68px"
                />
              </svg>
          ...
          >
            {board.map((row, i) =>
              row.map((cell, j) => (
                <rect
                  ...
                  x={5 + j * 105}
                  y={5 + i * 105}
                  fill={cell.active ? act : cell.occupied ? cell.color : bgcol}
                  key={`${i}-${j}`}
                />
              ))
            )}
            {ghost.map((pos: any, ind: any) => (
              <rect
				...
				style={{transitionDuration:autoplay?Math.min(25,dur/2)+"ms":"25ms"}}
                width={100}
                height={100}
                rx={10}
                x={5 + pos[1] * 105}
          ...
          <div className="w-[50vmin] mt-[-5vmin] absolute h-[20vmin]">
            <div
              ...
              style={{
                ...
                marginTop:
                  (paused || gameOver) && !controls ? "0vmin" : "10vmin",
                pointerEvents:
                  (paused || gameOver) && !controls ? "all" : "none",
              }}
            ></div>
            <div
            ...
            >
              <div className="text-[2.5vmin] ">{"Controls "}</div>
        ...
        <div className="h-full w-[18vmin]  flex flex-col justify-center items-center  text-white">
                      ...
                      {row.split("").map((cell) =>
                        cell !== "0" ? (
                          <div
                            className="w-[4vmin] aspect-square rounded-[0.4vmin] border border-blank"
                            style={{
                              backgroundColor: cols[nextShape],
                            }}
                          ></div>
                        ) : (
                          <div className="w-[4vmin] aspect-square "></div>
          ...
          <div className="h-full w-full flex flex-col items-center justify-center text-white">
            ...
            <div
              ...
              style={{
                backgroundColor: autp ? cols[4] + "22" : cols[5] + "22",
              }}
              onClick={() => {
                setAutp(!autp);
              }}
            >
              <div
                ...
                style={{
                  ...
                  backgroundColor: autp ? cols[4] : cols[5],
                }}
              ></div>
            </div>
            <div
            ...
            >
              <div className="text-[2vmin] mts w-full text-center">Weights</div>
              <div className="w-full flex justify-between px-[0.25vmin] gap-[1.5vmin]">
                <div className="w-[8.5vmin]  gap-[0.5vmin] justify-between flex ">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      weights.weightedBlocks = parseFloat(e.target.value);
                    }}
                  />
                </div>
                <div className="w-[8.5vmin]  gap-[0.5vmin] justify-between flex ">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      weights.connectedHoles = parseFloat(e.target.value);
                    }}
                  />
                </div>
              </div>
              ...
              <div className="w-full flex justify-between px-[0.25vmin] gap-[1.5vmin]">
                ...
                <div className="w-[8.5vmin]  gap-[0.5vmin] justify-between flex ">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      weights.pitholePercentage = parseFloat(e.target.value);
                    }}
                  />
                </div>
              </div>
              ...
              <div className="w-full flex justify-between px-[0.25vmin] gap-[1.5vmin]">
                <div className="w-[8.5vmin]  gap-[0.5vmin] justify-between flex ">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      weights.clearAbleLines = parseFloat(e.target.value);
                    }}
                  />
                </div>
                <div className="w-[8.5vmin]  gap-[0.5vmin] justify-between flex ">
            ...
            <div className="w-full mt-[4vmin] overflow-hidden rounded-full flex h-[1.5vmin]">
              {lcRect.map((val, i) => (
                <div
                  ...
                  style={{
                    width: ((val * (i + 1)) / linesCleared) * 100 + "%",
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      marginTop:
                        i % 2 == 0 ? (i == 0 ? "-3vmin" : "-3vmin") : "",
                      marginBottom:
                        i % 2 == 1 ? (i == 1 ? "-3vmin" : "-3vmin") : "",
                    }}
                  >
                    {val > 0 ? "-" : ""}
                  </div>
                  <div
                    ...
                    style={{
                      marginTop:
                        i % 2 == 0 ? (i == 0 ? "-6vmin" : "-6vmin") : "",
                      marginBottom:
                        i % 2 == 1 ? (i == 1 ? "-6vmin" : "-6vmin") : "",
                    }}
                  >
                    {val > 0 ? ["Single", "Double", "Triple", "Tetris"][i] : ""}
                  </div>
                </div>
              ))}
            </div>
